  ...
  describe('methods', function () {
    ...
    describe('#closeModal', function () {
      it('should dispatch an event to the game component', function () {
        ...
        expect(componentInstance.$dispatch).toHaveBeenCalledWith(constants.events.game.closeCrawl);
      });
    });
    ...
    describe('#playCrawl', function () {
      ...
      it('should set the crawl data', function () {
        expect(componentInstance.demoTitle).toEqual(mockCrawl.title);
        expect(componentInstance.demoSubtitle).toEqual(mockCrawl.subtitle);
        expect(componentInstance.demoCrawl).toEqual(mockCrawl.crawl);
        expect(componentInstance.demoImage).toEqual(mockCrawl.imageUrl);
      });

      it('should start the crawl', function () {
        expect(componentInstance.showDemoCrawl).toEqual(true);
      });
    });
  });
